...
//                    walletDao.add(KeyUtil.genWalletIdFromSeed(seed),SpUtil.getInstance().getWalletName(),SpUtil.getInstance().getWalletPw(),SpUtil.getInstance().getLoginPw(),0);
                    start(AddCoin.getInstance(false,key));
                }
            }
        });
