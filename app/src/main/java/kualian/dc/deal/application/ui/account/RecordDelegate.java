...
public class RecordDelegate extends BaseListDelegate {
    ...
    protected void onEvent() {
        ...
        TextView pay = inflate.findViewById(R.id.pay);
        TextView receive = inflate.findViewById(R.id.receive);
...
//        TextView iconName = mHeadView.findViewById(R.id.coin_name);
        ...
        if (coinType != null) {
            if (coinType.getCoinIndex() == 1) {
//                icon.setImageResource(R.mipmap.home_icon_ctc);
            } else {
//                icon.setImageResource(R.mipmap.home_icon_ctc);
            }
//            iconName.setText(coinType.getCoinName());
            if (SpUtil.getInstance().getDefaultMoney()){
                iconAddress.setText("≈ $"+coinType.getUsMoney());
            }else{
                iconAddress.setText("≈ ¥"+coinType.getCoinMoney());
            }
            iconMoney.setText(coinType.getCoinNum()+"CTC");
        }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.pay:
                ...
                break;
            case R.id.receive:
                MobclickAgent.onEvent(WalletApp.getContext(), UmengConstants.CLICK_RECEIVE);
            ...
            public void run() {
                ...
                if (response.getResponse() != null) {
                    ...
                    if (recordResponse != null && recordResponse.getData() != null) {
                        iconMoney.setText(recordResponse.getData().getNum()+"CTC");
