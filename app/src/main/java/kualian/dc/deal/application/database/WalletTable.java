...
public class WalletTable {
    ...
    public static final String WALLET_SEED= "wallet_seed";
    public static final String WALLET_IS_COPY_SEED= "wallet_seed_is_copy";
    ...
    public static final int ID_WALLET_SEED = 6;
    public static final int ID_WALLET_IS_COPY_SEED = 7;
