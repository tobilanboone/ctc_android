...
import static kualian.dc.deal.application.util.WalletTool.getContext;
...
public class RxToast {
    ...
    public static void showToast(int resId) {
        if (mToast == null) {
            mToast = Toast.makeText(getContext(), WalletApp.getContext().getResources().getString(resId), Toast.LENGTH_LONG);
        } else {
            mToast.setText(WalletApp.getContext().getResources().getString(resId));
        }
        mToast.show();
    }
